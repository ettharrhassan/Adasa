    ...
    <aside>
      <div className="sticky top-30 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-white/10 bg-white/3 px-4 py-4 text-center">
        ...
        <div className="rounded-2xl border border-orange-900/30 bg-linear-to-b from-orange-950/40 to-transparent px-5 py-6 text-center">
